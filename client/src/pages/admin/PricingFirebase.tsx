/**
 * PricingFirebase — 料金プラン管理画面（Firestore版）
...
export default function PricingFirebase() {
  const { docs: plans, loading: isLoading } = useCollection("plans");
  const { docs: competitors, loading: compLoading } = useCollection("competitorPlans");
