/**
 * AdminQuickRepliesFirebase — 定型文管理（Firestore版）
...
export default function AdminQuickRepliesFirebase() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editingId) {
        await updateDocument(editingId, { title, content });
      ...
      toast.error(editingId ? "更新に失敗しました" : "追加に失敗しました");
    }
  };
        ...
        <DialogContent className="max-w-lg">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!title.trim() || !content.trim() || addLoading || updateLoading}
