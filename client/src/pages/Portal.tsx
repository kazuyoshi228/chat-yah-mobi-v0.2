        ...
        <div className="w-full max-w-[340px]">
          ...
          <div className="bg-black rounded-2xl px-8 py-9 shadow-2xl shadow-black/20">
            ...
            <a
              ...
              className="group flex items-center gap-3 w-full px-5 py-3.5 bg-white hover:bg-gray-50 active:scale-[0.98] rounded-xl transition-all duration-150 ease-out mb-3"
            >
