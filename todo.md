...
- [ ] 多言語RAG（中国語・韓国語・タイ語・ベトナム語）に返金不可ポリシーセクションを追加
- [ ] 購入フロー同意チェックボックスの文言を確認（yah.mobi本体）
- [ ] 取扱説明書（日本語MD・日英PDF）に購入フロー同意チェックボックスのスクリーンショット反映
- [ ] 特定商取引法ページ（LegalPage.tsx）の返金ポリシー記述を更新
- [ ] 日英PDF再生成・ストレージアップロード・UserManuals.tsx URL更新
