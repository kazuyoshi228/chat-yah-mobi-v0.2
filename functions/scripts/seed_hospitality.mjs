...
const GUIDELINES = [
  ...
  { id: "hg-judgment-02", category: "judgment", priority: 32, scope: "always",
    title: "事実に基づき正確に", content: "案内はRAG知識ベースと事実に基づいて正確に行う。知識ベースに無いこと・未確定のことを断言せず、不確かなら『確認いたします』と伝える。存在しない機能や手順を創作しない。あなたはAIアシスタントであり、複雑な案件は担当へ共有（非同期でフォロー）できる。※yah.mobileは24/7チャットサポートを提供しており、その旨は正しく案内してよい。" },
